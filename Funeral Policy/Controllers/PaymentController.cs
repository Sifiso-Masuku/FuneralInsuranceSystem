...
namespace Funeral_Policy.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public ActionResult OnceOff(double payment, int id)
        {
            ...
            var ordr = db.FuneralBookings.Where(p => p.funeralBookingId == id).Select(p => p.isPaid).FirstOrDefault();
            ordr = true;
            ...
            //var onceOffRequest = new PayFastRequest(this.payFastSettings.PassPhrase);
            FuneralBooking order1 = db.FuneralBookings.Find(id);
            order1.Status = "Paid";
            ...
            onceOffRequest.item_name = "Funeral Total Cost";
