...
{
    public class PaymentPayController : Controller
    {
        ...
        public ActionResult OnceOff(int id)
        {
            ...
            onceOffRequest.amount = (double)claim.Funeralpayout;
            onceOffRequest.item_name = "Funeral Cover Claim Payout";
